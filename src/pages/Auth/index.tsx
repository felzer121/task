...
const Auth = () => {
  ...
  const shipRef = React.useRef<any>();
        ...
        <div className='auth__loginContainer'>
          ...
          <div className='auth__loginContent'>
            <div className='auth__loginTitle'>
              <Typography variant="h4" component="h4">Авторизация</Typography>
            ...
            <div className='auth__loginForm'>
              <Box mt={2} mb={2}>
                <FormControl sx={{width: '100%'}} variant="filled">
                  <InputLabel htmlFor="login" color='primary' sx={{color: '#6D6D6D', fontFamily: 'Heebo'}}>Login</InputLabel>
                  <DarkFilled required id="login" />
                </FormControl>
              </Box>
              <Box mt={2} mb={2}>
                <FormControl sx={{width: '100%'}} variant="filled">
                  <InputLabel htmlFor="login" color='primary' sx={{color: '#6D6D6D', fontFamily: 'Heebo'}}>Password</InputLabel>
                  <DarkFilled required id="login" />
                </FormControl>
              </Box>
            </div>
            <div className='auth__loginControl'>
              <Button variant="contained" className='auth__loginButton'>Войти</Button>
            </div>
          </div>
          <div>
            asggas
